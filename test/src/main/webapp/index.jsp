                        ...
                        <p class="voucher-expiry">
                            <c:choose>
                                <c:when test="${v.minOrder > 0}">
                                    Min: <fmt:formatNumber value="${v.minOrder}" />đ
                                </c:when>
                                <c:otherwise>
                                    Exp: ${v.expiryDate}
                                </c:otherwise>
                ...
                <div class="product-card">
                    ...
                    <div class="product-image">
                        <a href="product-detail?pid=${p.pid}">
                            <img src="${p.image != null ? p.image : 'img/no-image.png'}"
                                 alt="${p.pdescription}">
                        </a>

                        <a href="product-detail?pid=${p.pid}" class="overlay-btn">
                            <i class="fa-regular fa-eye"></i>
                        </a>

                        <c:if test="${stock <= 0}">
                            <span style="position: absolute; top: 10px; left: 10px; background: #e74a3b; color: white; padding: 5px 10px; font-size: 12px; font-weight: bold; border-radius: 4px;">
                                SOLD OUT
                            </span>
                        </c:if>
                    </div>
