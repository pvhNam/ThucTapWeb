<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List, dao.ProductDAO, dao.VoucherDAO, model.product, model.Voucher, java.text.DecimalFormat"%>
...
<body>
		...
		<div class="voucher-grid">
			...
			<div class="voucher-card">
				<div class="voucher-left">
					<span class="voucher-amount"><%= amountDisplay %></span> <span
						class="voucher-unit"><%= unitDisplay %></span>
				</div>
				<div class="voucher-right">
					...
					<button class="btn-save-voucher"
						onclick="saveVoucher(this, '<%= v.getCode() %>')">
		...
		<div class="product-grid">
			...
			<div class="product-card">
				<div class="product-image">
					<a href="product-detail?pid=<%=p.getPid()%>"> <img
						src="<%= (p.getImage() != null) ? p.getImage() : "img/no-image.png" %>"
						alt="<%=p.getPdescription()%>">
					</a> <a href="product-detail?pid=<%=p.getPid()%>" class="overlay-btn">
    ...
    function saveVoucher(btn, code) {
        ...
        .then(data => {
            ...
            if (result === "SUCCESS") {
                btn.innerText = "Saved ✓"; // Có thể dùng fmt nếu render từ server, nhưng JS hardcode tạm
