...
<head>
    ...
    <style>
        .form-container { max-width: 600px; margin: 50px auto; padding: 30px; border: 1px solid #ddd; border-radius: 8px; background: #fff; }
        .form-group { margin-bottom: 15px; }
        .form-group label { display: block; margin-bottom: 5px; font-weight: bold; }
        .form-group input, .form-group select { width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; }
        .btn-submit { background: #28a745; color: white; padding: 12px 20px; border: none; cursor: pointer; width: 100%; font-size: 16px; font-weight: bold; }
...
<body style="background: #f4f6f9;">
    <div class="form-container">
        ...
        <form action="admin-add-product" method="post">
            ...
            <div class="form-group">
                <label>Hình ảnh (Link hoặc tên file):</label>
                <input type="text" name="image" placeholder="Ví dụ: img/ao-thun.jpg">
            </div>
            <button type="submit" class="btn-submit">Thêm Sản Phẩm</button>
            <br><br>
            <a href="admin-orders.jsp" style="display:block; text-align:center; text-decoration:none; color:#555;">&larr; Quay lại Admin</a>
        </form>
    </div>
</body>
</html>