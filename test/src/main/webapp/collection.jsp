	...
	<div class="collection-wrapper">
		...
		<div class="collection-header">
			...
			<div class="filter-menu">
				<button class="filter-btn active" onclick="filterSelection('all')">Tất
					Cả</button>
				<button class="filter-btn" onclick="filterSelection('summer')">Mùa
					Hè</button>
				<button class="filter-btn" onclick="filterSelection('office')">Công
					Sở</button>
				<button class="filter-btn" onclick="filterSelection('party')">Dạ
					Hội</button>
		...
		<div class="gallery-grid">
			...
			<div class="gallery-item" data-category="summer">
				...
				<div class="item-overlay">
					...
					<p class="collection-desc">Hơi thở của biển cả trong từng thiết
						kế Linen thoáng mát.</p>
					<a href="index.jsp" class="btn-discover">KHÁM PHÁ NGAY <i
			...
			<div class="gallery-item" data-category="office">
				...
				<div class="item-overlay">
					...
					<p class="collection-desc">Phong cách tối giản, quyền lực dành
						cho quý cô hiện đại.</p>
					<a href="index.jsp" class="btn-discover">XEM CHI TIẾT <i
						class="fa-solid fa-arrow-right"></i></a>
				</div>
			</div>
			...
			<div class="gallery-item" data-category="party">
				...
				<div class="item-overlay">
					...
					<p class="collection-desc">Tỏa sáng dưới ánh đèn với những
						thiết kế đính kết thủ công.</p>
					<a href="index.jsp" class="btn-discover">XEM CHI TIẾT <i
						class="fa-solid fa-arrow-right"></i></a>
				</div>
			</div>
			...
			<div class="gallery-item" data-category="summer">
				...
				<div class="item-overlay">
					...
					<p class="collection-desc">Phụ kiện và trang phục đi biển mới
						nhất.</p>
					<a href="index.jsp" class="btn-discover">KHÁM PHÁ NGAY <i
						class="fa-solid fa-arrow-right"></i></a>
				</div>
			...
			<div class="gallery-item" data-category="vintage">
				<img
					src="https://images.unsplash.com/photo-1550614000-4b9519e09963?q=80&w=2070&auto=format&fit=crop"
					alt="Vintage">
				<div class="item-overlay">
					<span class="collection-tag">Classic</span>
					<h2 class="collection-name">Retro 90s</h2>
					<p class="collection-desc">Sự trở lại của những biểu tượng thời
						trang thập niên 90.</p>
					<a href="index.jsp" class="btn-discover">KHÁM PHÁ NGAY <i
						class="fa-solid fa-arrow-right"></i></a>
				</div>
			</div>
	...
	<footer class="footer">
		<div class="footer-top">
			<div class="contact">
				...
				<p>
					<strong>📍</strong> S2, đường Hải Triều, Q.1, TP HCM
				</p>
			</div>
		</div>
	</footer>
