	...
	<div class="login-container">
		<div class="login-wrapper">
			...
			<p class="login-subtitle">
				<fmt:message key="login.subtitle" />
			</p>
			...
			<form action="login" method="post" class="login-form">
				...
				<div class="form-options">
					<label class="remember-me"> <input type="checkbox"
						name="remember"> <fmt:message key="login.remember_me" />
					</label> <a href="forgotPassword" class="forgot-password"><fmt:message
							key="login.forgot_password" /></a>
				</div>

				<button type="submit" class="btn-login">
					<fmt:message key="login.btn_login" />
				</button>
