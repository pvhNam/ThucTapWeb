...
<style>
    ...
    .article-container { max-width: 800px; margin: 40px auto; padding: 0 20px; background: #fff; }
    
    /* Breadcrumb */
    .breadcrumb { font-size: 0.9rem; color: #888; margin-bottom: 20px; }
    .breadcrumb a { text-decoration: none; color: #333; font-weight: 600; }
    
    /* Header bài viết */
    .article-header { margin-bottom: 30px; text-align: center; }
    .article-title { font-size: 2rem; font-weight: 800; color: #1a1a1a; line-height: 1.3; margin-bottom: 15px; }
    .article-meta { color: #777; font-size: 0.9rem; font-style: italic; }
    
    /* Ảnh đại diện */
    .article-featured-img { width: 100%; height: auto; max-height: 500px; object-fit: cover; border-radius: 8px; margin-bottom: 30px; }
    ...
    .btn-back { display: inline-flex; align-items: center; gap: 8px; text-decoration: none; color: #333; font-weight: 600; padding: 10px 20px; border: 1px solid #ddd; border-radius: 30px; transition: 0.3s; }
    ...
    <header class="header">
        ...
        <div class="actions">
            <div class="account">
                ...
                if (currentUser != null) { %>
                    <div class="user-info">
                        <span>Hi, <%=currentUser.getFullname()%></span> 
    ...
    <div class="article-container">
        ...
        <div class="article-header">
            ...
            <div class="article-meta">
                ...
                <span>Fashion Store Team</span>
            </div>
        </div>

        <img src="<%=n.getImage()%>" alt="Ảnh bài viết" class="article-featured-img" onerror="this.src='img/no-image.png'">
        ...
        <div class="article-footer">
            <a href="news.jsp" class="btn-back">
