    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            if ("daily".equals(type)) {
                ...
                titleRow.createCell(0).setCellValue("BAO CAO DOANH THU NGAY " + date);
                titleRow.getCell(0).setCellStyle(headerStyle);
                rowIdx++;

                Row header = sheet.createRow(rowIdx++);
                String[] columns = {"Ten San Pham", "So Luong", "Don Gia", "Thanh Tien", "HT Thanh Toan"};
                ...
                sumRow.createCell(2).setCellValue("TONG CONG:");
                ...
                title.createCell(0).setCellValue("BAO CAO TONG QUAN THANG " + month + "/" + year);
                ...
                String[][] summaryData = {
                    {"Tong Tien Ban Hang", String.valueOf(totalSales)},
                    {"Thue (10%)", String.valueOf(tax)},
                    {"Tong Doanh Thu", String.valueOf(netRevenue)},
                };
                ...
                soldHeaderTitle.createCell(0).setCellValue("I. CHI TIET SAN PHAM DA BAN");
                soldHeaderTitle.getCell(0).setCellStyle(headerStyle);
                Row soldHeader = sheet.createRow(rowIdx++);
                String[] cols = {"Ten San Pham", "So Luong Ban", "Doanh Thu"};
                ...
                impHeaderTitle.createCell(0).setCellValue("II. LICH SU NHAP KHO");
                impHeaderTitle.getCell(0).setCellStyle(headerStyle);
                Row impHeader = sheet.createRow(rowIdx++);
                String[] impCols = {"Ngay Nhap", "Ten San Pham", "So Luong", "Gia Von/SP", "Tong Chi Phi"};
                ...
                sumImpRow.createCell(3).setCellValue("TONG TIEN NHAP HANG:");
            ...
            e.printStackTrace();
            response.getWriter().write("Loi xuat bao cao: " + e.getMessage());
        }
    }
}
